...
if("${PY_VERSION}" VERSION_LESS "3.0")
  ...
  elseif("${PY_VERSION}" VERSION_EQUAL "2.7.15")
    set(_py_version "2.7.15")
    message(STATUS "Using ${_py_version} patches for 2.7.15 <= PY_VERSION < 3.0.0")
  elseif("${PY_VERSION}" VERSION_EQUAL "2.7.16" OR "${PY_VERSION}" VERSION_GREATER "2.7.16")
    set(_py_version "2.7.16")
    message(STATUS "Using ${_py_version} patches for 2.7.16 <= PY_VERSION < 3.0.0")
  endif()
endif()
